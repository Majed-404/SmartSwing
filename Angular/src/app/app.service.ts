...
export class AppService {
  ...
  public getMenuItemById(id): Observable<MenuItem>{
  ...
  public filterData(data, categoryId:number, sort?, page?, perPage?){  
    if(categoryId){
